			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="bind">
						<div id="popupbox">
							<div id="deviceId">
								<form:form method="POST" action="signupform.im"
									modelAttribute="signupform" enctype="multipart/form-data">
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="country" /></span>
											<div id="text_setting">Country</div>
										</div>
										<div id="col">
											<form:select path="country" multiple="false"
												id="text_setting" required="required"
												title="Please select country of restaurant">
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="state" /></span>
											<div id="text_setting">State/Province</div>
										</div>
										<div id="col">
											<form:select path="state" multiple="false" id="text_setting"
												required="required"
												title="Please select state of restaurant">
												<form:option value="" label="Select" />
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="city" /></span>
											<div id="text_setting">City</div>
										</div>
										<div id="col">
											<form:input path="city" type="text" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="30" required="required"
												title="Please enter city of restaurant"
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="address" /></span>
											<div id="text_setting">Address</div>
										</div>
										<div id="col">
											<form:textarea path="address" type="text" id="textfield2"
												cols="46" rows="5"
												onkeyup="autoTab(this, document.form_device.locality)"
												required="required"
												title="Please enter address of restaurant"
												placeholder="Enter Address of Restaurant"></form:textarea>
										</div>
									</div>
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="zipcode" /></span>
											<div id="text_setting">Zipcode</div>
										</div>
										<div id="col">
											<form:input path="zipcode" type="tel" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="6" pattern="\d{6}"
												title="Please enter 6 digit zipcode" required="required"
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="rname" /></span>
											<div id="text_setting">Restaurant Name</div>
										</div>
										<div id="col">
											<form:input path="rname" type="text" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" title="Please enter name of restaurant"
												required="required" placeholder="Name of restaurant" />
										</div>
									</div>
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="rmailid" /></span>
											<div id="text_setting">Restaurant Email-ID</div>
										</div>
										<div id="col">
											<form:input path="rmailid" type="email" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="100" title="Please enter email-ID of restaurant"
												required="required" placeholder="eg. abc@swapnil.com" />
										</div>
									</div>
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="password" /></span> <span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center">${password_match}</span>
											<div id="text_setting">Password</div>
										</div>
										<div id="col">
											<form:input path="password" type="password" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												title="Min 8 characters Max 20, one number, one uppercase and one lowercase letter"
												pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*"
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="cpassword" /></span>
											<div id="text_setting">Confirm Password</div>
										</div>
										<div id="col">
											<form:input path="cpassword" type="password" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												title="Min 8 characters Max 20, one number, one uppercase and one lowercase letter"
												pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*"
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="rcontact" /></span>
											<div id="text_setting">Restaurant Contact</div>
										</div>
										<div id="col">
											<form:input path="rcontact" type="tel" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" pattern="\d{10}"
												title="Please enter contact number of restaurant"
												required="required"
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="raltcontact" /></span>
											<div id="text_setting">Restaurant Alternative Contact</div>
										</div>
										<div id="col">
											<form:input path="raltcontact" type="text" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" pattern="\d{10}"
												title="Please enter alternate contact number of restaurant"
												required="required"
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="rtype" /></span>
											<div id="text_setting">Restaurant Type</div>
										</div>
										<div id="col">
											<form:select path="rtype" multiple="false" id="text_setting"
												required="required" title="Please select type of restaurant">
												<form:option value="" label="Select" />
				                	...
				                	<div id="text_setting">
				         			Restaurant Sub Type
										...
										<div id="col">
											<form:input path="rsubtype" type="hidden" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" value=" . " />
										</div>
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="rmaxseats" /></span>
											<div id="text_setting">Restaurant Max Seating</div>
										</div>
										<div id="col">
											<form:input path="rmaxseats" type="tel" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												min="5" title="Please enter max vacancy of restaurant"
												maxlength="8" required="required"
												placeholder="Enter max vacancy" />
										</div>
									</div>
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="opentime" /></span>
											<div id="text_setting">Open Time</div>
										</div>
										<div id="col">
											<form:input path="opentime" type="time" step="900"
												id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												required="required"
												title="Please enter open time of restaurant" />
										</div>
									</div>
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="closetime" /></span>
											<div id="text_setting">Close Time</div>
										</div>
										<div id="col">
											<form:input path="closetime" type="time" step="900" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												id="text_setting" required="required"
												title="Please enter close time of restaurant" />
										</div>
									</div>
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="rrating" /></span>
											<div id="text_setting">Restaurant Rating</div>
										</div>
										<div id="col">
											...
											<form:select path="rrating" multiple="false"
												id="text_setting" required="required"
												title="Please select rating of restaurant">
												<form:option value="" label="Select" />
				                ...
				                <div id="col">
									...
									<div id="row">
										<div id="col">
											<span
												style="font-size: 12px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center"><form:errors
													path="files" /></span>
											<div id="text_setting">Upload Menu</div>
										</div>
										<div id="col">
											...
											<div class="fileupload fileupload-new"
												...
												<div class="input-append">
													...
													<span class="btn btn-file btn-danger" id="text-button">
														<span class="fileupload-new">Upload file</span> <input
														name="files[0]" type="file" required id="text_setting"
														required="required"
														title="Please upload menu of restaurant" />
													</span>
												</div>
											</div>
										</div>
									...
									<div id="row">
										<form:input path="timezone" type="hidden" id="timezone"
											onkeyup="autoTab(this, document.form_device.address)" />
										<button type="submit"
											class="pm-rounded-btn animated pm-primary">Submit</button>
									</div>
								</form:form>
							</div>
						</div>
