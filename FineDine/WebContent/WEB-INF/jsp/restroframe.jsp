						...
						<div id="popupbox">
							<div id="deviceId">
								<form name="form_device_1" method="post" action="">
									<span
										style="font-size: 14px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center">${userauthentication}</span>
									<div id="row">
										<div id="col">
											<div id="text_setting">Total Capacity</div>
										</div>
										<div id="col">
											<input name="pincode" type="text" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.name)"
												maxlength="6" />
										</div>
									</div>
									<div id="row">
										...
										<div id="col">
											<input name="name" type="text" id="textfield" size="60"
									...
									<div id="row">
										...
										<div id="col">
											<input name="contact" type="text" id="textfield" size="60"
									...
									<div id="row">
										...
										<div id="col">
											<textarea name="address" type="text" id="textfield2"
												cols="46" rows="5"
												onkeyup="autoTab(this, document.form_device.locality)"></textarea>
										</div>
									</div>
								</form>
							</div>
							...
							<div id="deviceId2">
								<form:form method="POST" action="billingform.im"
									modelAttribute="billingform" id="billingform">
									<c:set var="listError">
									...
									<div id="row">
										...
										<div id="col">
											<span
												style="font-size: 14px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center">${listError}</span>
											<span
												style="font-size: 14px; font-family: Georgia, 'Times New Roman', Times, serif; color: red; text-align: center">${emailError}</span>
											<form:input path="fnumber" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.contact)"
												required="required" placeholder="Enter flag number"
												title="Please enter flag number of customer" />
										</div>
									</div>
									<div id="row">
										<button type="submit"
											class="pm-rounded-btn animated pm-primary">Check out</button>
									</div>
								</form:form>
							</div>
							<div id="deviceId3">
