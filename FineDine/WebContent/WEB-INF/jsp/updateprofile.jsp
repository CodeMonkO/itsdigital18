			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="bind">
						<div id="popupbox">
							<div id="deviceId">
								<form:form method="POST" action="updateprofileform.im"
									...
									<div id="row">
										...
										<div id="col">
											<form:input path="rname" type="text"
												value="${updateProfile.rname}" id="textfield" size="60"
									...
									<div id="row">
										...
										<div id="col">
											<form:input path="rmailid" type="text"
												value="${updateProfile.rmailid}" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="100" />
										</div>
									</div>
									...
									<div id="row">
										...
										<div id="col">
											<form:input path="rcontact" type="text"
												value="${updateProfile.rcontact}" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" />
										</div>
									</div>
									<div id="row">
										...
										<div id="col">
											<form:input path="raltcontact" type="text"
												value="${updateProfile.raltcontact}" id="textfield"
												size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" />
										</div>
									...
									<div id="row">
										...
										<div id="col">
											<form:input path="rmaxseats" type="text"
												value="${updateProfile.rmaxseats}" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" />
										</div>
									</div>
									<div id="row">
										...
										<div id="col">
											<form:input path="opentime" type="time"
												value="${updateProfile.opentime}" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" />
										</div>
									</div>
									<div id="row">
										...
										<div id="col">
											<form:input path="closetime" type="time"
												value="${updateProfile.closetime}" id="textfield" size="60"
												onkeyup="autoTab(this, document.form_device.address)"
												maxlength="10" />
										</div>
									</div>
