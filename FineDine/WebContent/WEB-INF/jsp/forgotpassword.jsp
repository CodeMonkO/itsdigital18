				        ...
				        <!-- <span style="font-size:14px;font-family:Georgia, 'Times New Roman', Times, serif;color:red; text-align:center">Order Device Form:</span> -->
				   		    <div id="row" >
				            	...
				            	<div id="col">
				                	...
				                	<form:input path="email" type="text" id="email" size="60" onkeyup="autoTab(this, document.form_device.name)" maxlength="100" required="required" placeholder="eg.abc@example.com"/>
				                </div>
				   		 	</div>
				             <div id="row"  >
